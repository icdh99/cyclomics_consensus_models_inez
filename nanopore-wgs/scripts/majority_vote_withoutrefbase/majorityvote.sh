...
# nieuwe masked ref base: 10-39 voor crossval. 40-59 voor test data
...
out_file=(/hpc/compgen/projects/gw_cfdna/snv_qs/nanopore-wgs/scripts/majority_vote_withoutrefbase/results_majorityvote_chr18_subset_c$1_$SLURM_ARRAY_TASK_ID.txt)
