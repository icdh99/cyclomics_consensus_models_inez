...
# JOIN MATRICES 
if coverage_bin == 5: # gaat over test set coverage 
    model_coverage = '3-5X'
    dropout_1 = 0.2
    dropout_2 = 0.1
    dropout_last = 0.2
    coverage_list = [3,4,5]
if coverage_bin == 10: 
    model_coverage = '6-10X'
    dropout_1 = 0.3
    dropout_2 = 0.8
    dropout_last = 0.4
    coverage_list = [6,7,8,9,10]
if coverage_bin == 15: 
    model_coverage = '11-15X'
    dropout_1 = 0.2
    dropout_2 = 0.2
    dropout_last = 0.2
    coverage_list = [11,12,13,14,15]
if coverage_bin == 20: 
    model_coverage = '15-20X'
    dropout_1 = 0.3
    dropout_2 = 0.2
    dropout_last = 0.3
    coverage_list = [16,17,18,19,20]
if coverage_bin == 100: 
    model_coverage = '3-20X'
    dropout_1 = 0.7
    dropout_2 = 0.6
    dropout_last = 0.2
...
# sns.heatmap(cm, cmap=sns.color_palette("coolwarm", as_cmap=True), annot=True, fmt='g', ax=ax)
sns.heatmap(cm, cmap='Blues', annot=True, fmt='g', ax=ax)
ax.set_xticklabels(labels)
ax.set_yticklabels(labels)
ax.set_xlabel('Predicted labels')
ax.set_ylabel("True Labels")
list_name = name_model.split('_')
if int(list_name[1]) == 5: model_coverage_coverage = '3-5X'
if int(list_name[1]) == 10: model_coverage_coverage = '6-10X'
if int(list_name[1]) == 15:  model_coverage_coverage = '11-15X'
if int(list_name[1]) == 20: model_coverage_coverage = '15-20X'
if int(list_name[1]) == 100: model_coverage_coverage = '3-20X'

ax.set_title(f'Model: {list_name[0].upper()} {model_coverage_coverage} \n Coverage of test set: {model_coverage}')
