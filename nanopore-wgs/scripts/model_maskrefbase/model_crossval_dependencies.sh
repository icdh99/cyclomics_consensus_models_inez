...
sbatch -J crossval_5 -o R-%x.%j.out model_crossval.sh cnn 5
sbatch -J crossval_10 -o R-%x.%j.out model_crossval.sh cnn 10
sbatch -J crossval_15 -o R-%x.%j.out model_crossval.sh cnn 15
sbatch -J crossval_20 -o R-%x.%j.out model_crossval.sh cnn 20
sbatch -J crossval_100 -o R-%x.%j.out model_crossval.sh cnn 100
