...
if coverage_bin == 5: # NOG AANPASSEN
    dropout_1 = 0.2
    dropout_2 = 0.1
    dropout_last = 0.2
    coverage_list = [3,4,5]
...
for train, val in kfold.split(x_trainval, y_trainval.argmax(1)):
    ...
    print('perc wrong: ', np.sum(y_pred_max != y_test_max)/x_test.shape[0]*100)
    print('samples wrong: ', np.count_nonzero(y_pred_max != y_test_max))
