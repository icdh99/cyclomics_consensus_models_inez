...
sns.countplot(data=df_concat, x = 'read-cov', hue = 'model-cov', order = coverage, hue_order = hue_order)
...
plt.savefig('plot2_meanerrorrate_allreads_overlap.png', bbox_inches='tight')
...
sns.barplot(data=df_concat_overlap, x='read-cov', y ='score', order=coverage,  palette = sns.color_palette("Paired", 19))
...
coverage = ['3X','4X','5X','6X','7X','8X','9X','10X','11X','12X','13X', '14X','15X','16X','17X','18X','19X','20X','20+X']
hue_order = ['Cycas Consensus', 'c5', 'c10', 'c15', 'c20', 'c100']
# sns.barplot(data=df_concat, x='read-cov', hue='model-cov', y ='score', order=coverage, hue_order=hue_order, palette = sns.color_palette("Paired", 6))
